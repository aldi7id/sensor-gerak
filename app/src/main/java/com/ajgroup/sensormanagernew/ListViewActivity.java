package com.ajgroup.sensormanagernew;
    ...
    private void TampilSQLiteDBData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Y_ArrayList.add(cursor.getString(cursor.getColumnIndexOrThrow(SQLiteHelper.KEY_Y)));
                Z_ArrayList.add(cursor.getString(cursor.getColumnIndexOrThrow(SQLiteHelper.KEY_Z)));
